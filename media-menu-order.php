...
add_filter('attachment_fields_to_edit', 'media_menu_order_field', 1, 2);

function media_menu_order_save($attachment_id) {
	if (isset($_REQUEST['attachments'][$attachment_id]['menu_order2'])) {
		$menu_order = $_REQUEST['attachments'][$attachment_id]['menu_order2'];
...
add_action('edit_attachment', 'media_menu_order_save');
